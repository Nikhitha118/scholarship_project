    ...
    def check(self, user: User, scholarship: Scholarship) -> Dict:
        ...
        if scholarship.accepted_categories:
            ...
            if user.category is None:
                ...
                accepted = [
                    str(cat).upper()
                    for cat in scholarship.accepted_categories
                ]
                ...
                if user_cat not in accepted:
                    return {
                        "is_eligible": False,
                        "score": 0,
                        "notes": f"Category {user.category} not accepted",
                        "missing": [],
        ...
        if scholarship.course_type:
            ...
            if user.course is None:
                ...
                user.course
                and scholarship.course_type.lower()
                not in user.course.lower()
            ):
                score -= 30
                notes.append(
